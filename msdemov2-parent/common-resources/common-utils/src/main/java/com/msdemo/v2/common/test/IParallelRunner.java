...
public interface IParallelRunner {
	...
	default void logic(){throw new RuntimeException("logic not implemented");};
	
	default void logic1(){throw new RuntimeException("logic1 not implemented");};
	default void logic2(){throw new RuntimeException("logic2 not implemented");};
